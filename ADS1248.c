...
/*
 * ADS1248.c is the "driver" for the ADS1248.  It assumes 20SPS is
 ...
 * pollADS1248(short channel, int trials): gets trials # conversions from the specified
 ...
 * SSI3.
 *
 * ADS1248GetValue() returns just 1 count. ADS1248GetValue() does not include
 * any delays...the user should be sure to give appropriate delays between conversions.
 * ADS1248ChangeChannel(...) allows you to switch between the 4 differential
 * channels (0,1,2,3).
 */
...
{
	//set up ADS1248's GPIO enable pin (pin 71)
...
*/
    ...
    //allow the ADS1248 proper calibration time
...
/*
 * Configures the SSI2 line to the ADS1248.
 */
void setUpSSIADS1248(void)
{
	unsigned long ulDataRx[1];

	//SSI2 runs to ADS1248
	...
	//MOTO_MODE_1 is what we want to use for the ADS1248!!
	...
	// Flush receive FIFO before starting to talk to ADS1248.
